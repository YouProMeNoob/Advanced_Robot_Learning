...
if __name__ == "__main__":
    problem = "You need to think and response. Put your thinking in <think><\think> tags. Put your final answer in <ans><\ans> tags. How many r's are in the word strawberry?"
    problem = "1.02 * 3.13 / 2.1 = ?"
