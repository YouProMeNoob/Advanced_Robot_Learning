...
if __name__ == "__main__":
    ...
    bag_path = '/root/catkin_ws/recordings/pick1.bag'
    ...
    new_start[:3] += np.array([-0,0,0])
    new_goal[:3] += np.array([0.05, 0.1, 0.05])  # Modify position
    ...
    print(IK_joint_trajectory.shape)
