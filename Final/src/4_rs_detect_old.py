...
class GPUObjectDetector:
    def __init__(self):
        ...
        # Load parameters
        self.model_path = "/root/catkin_ws/src/my_scripts/assignment_2/yolo_results_1/train/weights/best.pt" #rospy.get_param("~model_path", "yolov8n.pt")
        self.confidence = 0.2 #rospy.get_param("~confidence", 0.5)
        self.sam_ckpt = "sam2_b.pt" #rospy.get_param("~sam_ckpt")
        self.object = ["one","two", "three", "four", "five"]    #rospy.get_param("~object")
        self.prev_X = None
        self.prev_Y = None
        self.prev_Z = None
